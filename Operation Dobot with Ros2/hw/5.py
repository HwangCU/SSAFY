...
def main(args=None):
    ...
    while num != '0':
        ...
        if num == '1': 
            action_client.send_goal(target = [112.0, -189.0, 50.0, 0.0], mode = 1)
            time.sleep(5)
            action_client.send_goal(target = [112.0, -189.0, -54.0, 0.0], mode = 1)
            time.sleep(2)
            ...
            action_client.send_goal(target = [150.0, -2.0, 85.0, 0.0], mode = 1)
            time.sleep(2)

            action_client.send_goal(target = [108.0, 133.0, 50.0, 0.0], mode = 1)
            time.sleep(2)
            action_client.send_goal(target = [108.0, 133.0, -45.0, 0.0], mode = 1)
            time.sleep(2)
            action_client.turn_suction(False)
            time.sleep(2)
            action_client.send_goal(target = [108.0, 133.0, 50.0, 0.0], mode = 1)
